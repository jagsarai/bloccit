...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "PUT update" do
    ...
    it "updates sponsored_post with expected attributes" do
      ...
      update_sponsored_post = assigns(:sponsored_post)
      expect(update_sponsored_post.id).to eq my_sponsored_post.id
      expect(update_sponsored_post.title).to eq new_title
      expect(update_sponsored_post.body).to eq new_body
      expect(update_sponsored_post.price).to eq new_price
    end
